...
| 6 | 2026-02-01 | `.footer-item {height: 100px;}` doesn't function
| 7 | 2026-02-02 | _base.html_ `{% if request.path == login_url | request.path == logout_url | request.path == signup_url %}` not functional