...
| 10 | 2026-03-17 | _question_answer_detail.html_ & _test_answer_detail.html_ don't display as blocks | 2026-04-01 | ~~As expected, _answer/url.py_ `url_patterns = [path('<slug:slug>/', views.answer_detail_test, name='answer_detail_test'),]`~~ | ~~[main 220d7f8] fix url pathing~~ | Credit to Raghav Kovvuri :bug: We thought we'd fixed it, but we did not :persevere: |
| 11 | 2026-04-05 | _test_list.html_ is paginated without a method of navigating to subsequent pages |
